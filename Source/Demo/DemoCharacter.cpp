...
void ADemoCharacter::UpdateAnimation()
{
...
void ADemoCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	StopJumping();
}

void ADemoCharacter::UpdateCharacter()
{
